...
> `my-progress/` shows engagement with the previous lesson. Day 001 is next and stays
> Day 001 until it's actually met. Earlier lessons: `archive/pre-reset-2026-07-22/` and
> `archive/pre-reset-2026-07-24/`.
...
---
_Round: 1 (first pass). After topic 82, Round 2 restarts from topic 1 at deeper depth._
